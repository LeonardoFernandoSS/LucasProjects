...
#if UNITY_ANDROID
		AdMobAndroid.init("ca-app-pub-xxxxxxxxxxxxxxxx");
#endif
...
#if UNITY_ANDROID
		AdMobAndroid.createBanner("ca-app-pub-xxxxxxxxxxxxxxxx/xxxxxxxxxx", AdMobAndroidAd.phone320x50, AdMobAdPlacement.BottomCenter);
#elif UNITY_IPHONE
...
#if UNITY_ANDROID
		AdMobAndroid.requestInterstital("ca-app-pub-xxxxxxxxxxxxxxxx/xxxxxxxxxxx");
#elif UNITY_IPHONE
